...
#Read in files
ad_sfm<-read.csv("T:/Benthic/Data/SfM/Calibration QC/HARAMP19_SfMAdult_CLEANED.csv")
j_sfm<-read.csv("T:/Benthic/Data/SfM/Calibration QC/HARAMP19_SfMJuv_CLEANED.csv") 
