...
jcdG_stS$JuvColDenW_new<-jcdG_stS$JuvColDen*jcdG_stS$w
...
mod<-glm(JuvCount~ANALYSIS_YEAR,family="poisson",data=jcdG_stS)
...
delta_r$sig<-c("abcd","a","cd","d","abc","ab","abcd","ab")
