...
data<-tribble( ~peak_date, ~REGION, ~displ,~type,
               ymd(20130915), "MARIAN", 0.8,"Bleaching Event",
               ymd(20140825), "MARIAN", 0.8,"Bleaching Event",
               ymd(20160830), "MARIAN", 0.8,"Bleaching Event",
               ymd(20170830), "MARIAN", 0.8,"Bleaching Event",
               ymd(20141015), "MHI", 0.4,"Bleaching Event",
               ymd(20151020), "MHI", 0.8,"Bleaching Event",
               ymd(20141001), "NWHI", 0.6,"Bleaching Event",
               ymd(20151030), "LINE", 0.4,"Bleaching Event",
               ymd(20150315), "SAMOA", 0.5,"Bleaching Event",
