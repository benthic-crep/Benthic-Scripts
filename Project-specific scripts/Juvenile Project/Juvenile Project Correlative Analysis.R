...
#remove columns
df<-subset(df,select=-c(RUBBLE,SAND,MA,MeanMaxDepth,Carbonate_HC,Sand_Rubble_HC,utmlat_strata_weighted_mean,HUMANS200_mean,SE_MEAN_SH,meankdPAR,MaxMaxDHW10))
