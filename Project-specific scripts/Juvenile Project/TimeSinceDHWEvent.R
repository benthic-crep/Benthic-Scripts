...
#load("M:/Environmental Data Summary/DataDownload/Degree_Heating_Weeks/RAW/Maui_raw_Degree_Heating_Weeks.RData")
...
#kahoolawe- reported >8 dhw in March 2019 - remove these data.
