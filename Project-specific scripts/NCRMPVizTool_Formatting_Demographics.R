...
demo.st<-demo.st %>% mutate(STRATAcode=recode(STRATA,
                                           `FD`="FRF_D",
                                           `FM`="FRF_M",
                                           `FS`="FRF_S",
                                           `BD`="BRF_D",
...
demo.st<-demo.st[,c("JURISDICTIONname","JURISDICTIONcode","SUBREGIONname","SUBREGIONcode", "SECTORname","SECTORcode","STRATAname","STRATAcode","SurveyYearStart","SurveyYearEnd","AnalysisYear","N","TaxonomicResolution","TaxonomicCode","ScientificName",
...
demo.sec<-demo.sec[,c("JURISDICTIONname","JURISDICTIONcode","SUBREGIONname","SUBREGIONcode", "SECTORname","SECTORcode","SurveyYearStart","SurveyYearEnd","AnalysisYear","N",
                      ...
                      "JuvenileDensity_SE","BleachingPrevalence_SE","DiseasePrevalence_SE")]
demo.isl<-demo.isl[,c("JURISDICTIONname","JURISDICTIONcode","SUBREGIONname","SUBREGIONcode","SurveyYearStart","SurveyYearEnd","AnalysisYear","N",
                        "TaxonomicResolution","TaxonomicCode","ScientificName","AdultDensity_colperm2","JuvenileDensity_colperm2","BleachingPrevalence_Pct","DiseasePrevalence_Pct","AdultDensity_SE",         
                      "JuvenileDensity_SE","BleachingPrevalence_SE","DiseasePrevalence_SE")]
...
write.csv(demo.st,file="T:/Benthic/Data/Data Requests/NCRMPViztool/2022/PacificNCRMPviztool2022_STRATA_demo.csv",row.names = F)
write.csv(demo.sec,file="T:/Benthic/Data/Data Requests/NCRMPViztool/2022/PacificNCRMPviztool2022_SECTOR_demo.csv",row.names = F)
write.csv(demo.isl,file="T:/Benthic/Data/Data Requests/NCRMPViztool/2022/PacificNCRMPviztool2022_ISLAND_demo.csv",row.names = F)
write.csv(demo.r,file="T:/Benthic/Data/Data Requests/NCRMPViztool/2022/PacificNCRMPviztool2022_REGION_demo.csv",row.names = F)
write.csv(site,file="T:/Benthic/Data/Data Requests/NCRMPViztool/2022/PacificNCRMPviztool2022_site_demo.csv",row.names = F)
