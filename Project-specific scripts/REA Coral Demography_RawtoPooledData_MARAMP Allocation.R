...
site_master<-read.csv("C:/Users/Courtney.S.Couch/Documents/GitHub/fish-paste/data/defunct SITE MASTER.csv");nrow(site_master)
...
colnames(jcdG_st)<-c("REGION","ISLAND","ANALYSIS_YEAR","Stratum","GENUS_CODE","n","Ntot","JuvColDen","SE_JuvColDen","Juv_avp","Juv_seprop","Juv_Abun","Juv_SE_Abun","Juv_CV")
...
st.data.gen<-subset(st.data.gen,ISLAND %in% c("Guam","Rota","Saipan","Aguijan","Tinian","Pagan","Maug") & GENUS_CODE %in% c("POSP","LEPT","POCS","ACSP","GOSP"))

write.csv(st.data.gen,"Marianas2017_for2020allocation.csv")
