...
# OUTPUT_LEVEL<-c("REGION","ISLAND","ANALYSIS_SEC","STRATA") 
# dpst<-Calc_Pooled_Simple(dps$Mean, dps$SampleVar, data.cols, OUTPUT_LEVEL, "AREA_HA")
# write.csv(dpst, file="T:\Benthic\Data\Data Requests/BenthicCover_2010-2019_Tier1_STRATA.csv")
# 
# # e.g. SAVE BY SECTOR PER YEAR
# OUTPUT_LEVEL<-c("REGION","ISLAND","ANALYSIS_SEC") 
