...
###### Table 1. Reef zone (FRF = Fore reef, BRF = Backreef, LAG = Lagoon, PRS = Protected Slope) area (hectare) and number of sites surveyed (n) for the three depth cateogires surveyed in the `r reg_name(reg)`.
```{r, echo = FALSE}
...
Fig3plot<-ggplot(ad, aes(x=Depth, y=Density,group=Island)) + 
  ...
  ylab(expression(bold("Juvenile Density (no.colonies"*~m^"-2"*")"))) + xlab(expression(bold("Maximum Depth (ft)")))+
...
###### Figure 4. Mean island-wide density of adult colonies (± SE) for total scleractinians and the four most abundant genera: `r strsplit(gen1," ")[[1]][1]`, `r strsplit(gen2," ")[[1]][1]`, `r strsplit(gen3," ")[[1]][1]`, `r strsplit(gen4," ")[[1]][1]`,and `r strsplit(gen5," ")[[1]][1]`.
...
Fig5plot
```
###### Figure 5. Mean island-wide density of juvenile colonies (± SE) for total scleractinians and the four most abundant genera: `r strsplit(gen1," ")[[1]][1]`, `r strsplit(gen2," ")[[1]][1]`, `r strsplit(gen3," ")[[1]][1]`,`r strsplit(gen4," ")[[1]][1]`,and `r strsplit(gen5," ")[[1]][1]`.

*Coral condition and threatened species*- The percent of adult coral colonies exhibiting signs of bleaching, disease, or crown-of-thorns sea star (COTS) predation lesions are shown in Table 1. 'Bleaching' included any loss of pigmentation. 'Acute Disease' was defined diseases resulting in tissue mortality. 'Acute Disease' refers to diseases that do not result in tissue loss. 'COTS' was defined as recent coral mortality attributable to COTS predation.The Endangered Species Act (ESA) threatened species were not observed during.
