...
#set all Backreef to a single DEPTH_ZONE ("All") - DOUBLE CHECK WITH DIONE
...
###Work with Dione to adapt this for the benthic data
...
##Code copied from fish code- not yet adapted for benthic data
...
#generate within strata means and vars -before weighting
...
#SOME EXAMPLES OF POOLING THAT CALCULATES WEIGHTED MEAN AND SE FOR POOLED DATA
...
dp<-Calc_Pooled_Simple(dps$Mean, dps$SampleVar, data.cols, OUTPUT_LEVEL, "AREA_HA")
save(dp, file="data_pooled_region.rdata")
