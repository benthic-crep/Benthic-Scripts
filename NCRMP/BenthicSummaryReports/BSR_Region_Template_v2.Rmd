...
###### Table 1. Reef zone (FRF = Forereef, BRF = Backreef, LAG = Lagoon, PRS = Protected Slope), area (hectare), and number of sites surveyed (n) for the three depth categories surveyed in the `r reg_name(reg)`.
```{r, echo = FALSE}
...
###### Figure 4. Mean island-wide density of adult colonies (± SE) for total scleractinians and the four most abundant genera: `r Note: the scale of the y-axis is not consistent across taxa.

strsplit(gen1," ")[[1]][1]`, `r strsplit(gen2," ")[[1]][1]`, `r strsplit(gen3," ")[[1]][1]`, `r strsplit(gen4," ")[[1]][1]`,and `r strsplit(gen5," ")[[1]][1]`.
...
INSERT BENTHIC HIGHLIGHTS FROM CRUISE REPORT


## Survey sampling design & methods  
A single stage stratified random sampling design was employed to survey the PRIMNM. The stratification scheme incorporated all forereef, backreef, lagoon and protected reef slope hard bottom habitats, and sampled across three depth categories: shallow (0-6 m), mid (>6-18 m) and deep (>18-30 m). Allocation of sampling effort was proportional to total strata area. Sites (geographic coordinates) were randomly selected within each stratum.
