...
#Complete
st_demo_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicREA_STRATA_GENUS_CODE_COMPLETE_2013_2024.csv")
...
#Trends
st_demo_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicREA_STRATA_GENUS_CODE_TRENDS_2013_2024.csv")
...
#Complete
sec_demo_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicREA_SECTOR_GENUS_CODE_COMPLETE_2013_2024.csv")
...
#Trends
sec_demo_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicREA_SECTOR_GENUS_CODE_TRENDS_2013_2024.csv")
...
#Complete
isl_demo_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicREA_ISLAND_GENUS_CODE_COMPLETE_2013_2024.csv")
...
#Trends
isl_demo_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicREA_ISLAND_GENUS_CODE_TRENDS_2013_2024.csv")
...
#Complete
r_demo_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicREA_REGION_GENUS_CODE_COMPLETE_2013_2024.csv")
...
#Trends
r_demo_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicREA_REGION_GENUS_CODE_TRENDS_2013_2024.csv")
...
#Complete
st_cover_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier1_STRATA_Complete_Viztool.csv")
...
#Trends
st_cover_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier1_STRATA_Trends_Viztool.csv")
...
#Complete
sec_cover_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier1_SECTOR_Complete_Viztool.csv")
...
#Trends
sec_cover_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier1_SECTOR_Trends_Viztool.csv")
...
#Complete
isl_cover_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier1_ISLAND_Complete_Viztool.csv")
...
#Trends
isl_cover_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier1_ISLAND_Trends_Viztool.csv")
...
#Complete
r_cover_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier1_REGION_Complete_Viztool.csv")
...
#Trends
r_cover_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier1_REGION_Trends_Viztool.csv")
...
#STRATA - Complete
st_cover2w_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier2b_STRATA_Complete_Viztool.csv")
...
#STRATA - Trends
st_cover2w_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier2b_STRATA_Trends_Viztool.csv")
...
#SECTOR - Complete
sec_cover2w_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier2b_SECTOR_Complete_Viztool.csv")
...
#SECTOR - Trend
sec_cover2w_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier2b_SECTOR_Trends_Viztool.csv")
...
#ISLAND - Complete
isl_cover2w_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier2b_ISLAND_Complete_Viztool.csv")
...
#ISLAND - Trend
isl_cover2w_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier2b_ISLAND_Trends_Viztool.csv")
...
#REGION - Complete
r_cover2w_CO<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/COMPLETE/BenthicCover_2010-2024_Tier2b_REGION_Complete_Viztool.csv")
...
#REGION - Trends
r_cover2w_TR<-read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/TRENDS/BenthicCover_2010-2024_Tier2b_REGION_Trends_Viztool.csv")
...
# it's fine to have a many-to-many relationship with this join...
st_CO_lu_years <- st_lu %>% left_join(st_CO %>% distinct(REGION, ANALYSIS_YEAR,GENUS_CODE), by = c("REGION"),relationship = "many-to-many")
st_TR_lu_years <- st_lu %>% left_join(st_TR %>% distinct(REGION, ANALYSIS_YEAR,GENUS_CODE), by = c("REGION"),relationship = "many-to-many")
...
#Create list of all possible strata and analysis year
sec_CO_lu_years <- sec_lu %>% left_join(sec_CO %>% distinct(REGION, ANALYSIS_YEAR,GENUS_CODE), by = c("REGION"),relationship = "many-to-many")
sec_TR_lu_years <- sec_lu %>% left_join(sec_TR %>% distinct(REGION, ANALYSIS_YEAR,GENUS_CODE), by = c("REGION"),relationship = "many-to-many")
...
#Create list of all possible strata and analysis year
isl_CO_lu_years <- isl_lu %>% left_join(isl_CO %>% distinct(REGION, ANALYSIS_YEAR,GENUS_CODE), by = c("REGION"),relationship = "many-to-many")
isl_TR_lu_years <- isl_lu %>% left_join(isl_TR %>% distinct(REGION, ANALYSIS_YEAR,GENUS_CODE), by = c("REGION"),relationship = "many-to-many")
...
years<-c("2013","2013-15","2014-15","2014","2015","2016","2015-16","2017-18","2017","2018","2019","2022","2023","2024")
...
####Add JoinKey
####
templ_str=read.csv("D:/PRE2025_CDrive/Users/Thomas.Oliver/WORK/Projects/FY23/Viztool/PacBenthicStrat_Trend_NJK.csv")
templ_sec=read.csv("D:/PRE2025_CDrive/Users/Thomas.Oliver/WORK/Projects/FY23/Viztool/PacBenthicSec_Trend_NJK.csv")
templ_isl=read.csv("D:/PRE2025_CDrive/Users/Thomas.Oliver/WORK/Projects/FY23/Viztool/PacBenthicSubjur_Trend_NJK.csv")
templ_reg=read.csv("D:/PRE2025_CDrive/Users/Thomas.Oliver/WORK/Projects/FY23/Viztool/PacBenthicJur_Trend_NJK.csv")
...
#Move Lehua Manually
SEC_JKlu.df=read.csv("./NCRMP/NCRMP Viztool/JoinKeySectorLookup_25May2023.csv",header = F)
...
write.csv(x = output_ST_Ljoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_STRATA_LEFTJOIN_byGenus_2025DEC12.csv")
write.csv(x = output_ST_Fjoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_STRATA_FULLJOIN_byGenus_2025DEC12.csv")

MostRecentYear="2024"
output_ST_Ljoin24=output_ST_Ljoin %>% filter(SurveyYearStart==2024)
output_ST_Fjoin24=output_ST_Fjoin %>% filter(SurveyYearStart==2024)
write.csv(x = output_ST_Ljoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_STRATA_LEFTJOIN_24ONLY_byGenus_2025DEC12.csv")
write.csv(x = output_ST_Fjoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_STRATA_FULLJOIN_24ONLY_byGenus_2025DEC12.csv")
...
write.csv(x = output_SEC_Ljoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_SECTOR_LEFTJOIN_byGenus_2025DEC12.csv")
write.csv(x = output_SEC_Fjoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_SECTOR_FULLJOIN_byGenus_2025DEC12.csv")

MostRecentYear="2024"
output_SEC_Ljoin24=output_SEC_Ljoin %>% filter(SurveyYearStart==2024)
output_SEC_Fjoin24=output_SEC_Fjoin %>% filter(SurveyYearStart==2024)
write.csv(x = output_SEC_Ljoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_SECTOR_LEFTJOIN_24ONLY_byGenus_2025DEC12.csv")
write.csv(x = output_SEC_Fjoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_SECTOR_FULLJOIN_24ONLY_byGenus_2025DEC12.csv")
...
write.csv(x = output_isl_Ljoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_ISLAND_LEFTJOIN_byGenus_2025DEC12.csv")
write.csv(x = output_isl_Fjoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_ISLAND_FULLJOIN_byGenus_2025DEC12.csv")

MostRecentYear="2024"
output_isl_Ljoin24=output_isl_Ljoin %>% filter(SurveyYearStart==2024)
output_isl_Fjoin24=output_isl_Fjoin %>% filter(SurveyYearStart==2024)
write.csv(x = output_isl_Ljoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_ISLAND_LEFTJOIN_24ONLY_byGenus_2025DEC12.csv")
write.csv(x = output_isl_Fjoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_ISLAND_FULLJOIN_24ONLY_byGenus_2025DEC12.csv")
...
write.csv(x = output_r_Ljoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_REGION_LEFTJOIN_byGenus_2025DEC12.csv")
write.csv(x = output_r_Fjoin,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_REGION_FULLJOIN_byGenus_2025DEC12.csv")

MostRecentYear="2024"
output_r_Ljoin24=output_r_Ljoin %>% filter(SurveyYearStart==2024)
output_r_Fjoin24=output_r_Fjoin %>% filter(SurveyYearStart==2024)
write.csv(x = output_r_Ljoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_REGION_LEFTJOIN_24ONLY_byGenus_2025DEC12.csv")
write.csv(x = output_r_Fjoin24,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/PacificBenthicDataSummaryTable_REGION_FULLJOIN_24ONLY_byGenus_2025DEC12.csv")


##############################################################################################################################################################################################
##############################################################################################################################################################################################
#1. Compare FULL and LEFT for most recent year, 
#2. split regions
#3. Output Submisison files
inpath=c("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/FULL_AND_LEFT/")
infile_A="PacificBenthicDataSummaryTable_"
infile_F="_FULLJOIN_24ONLY_byGenus_2025DEC12.csv"
infile_L="_LEFTJOIN_24ONLY_byGenus_2025DEC12.csv"
outpath=c("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/")
outfile_A=c("VizTool_")
outfile_B=c("_2024_v1.0.csv")

SPACE=c("REGION","ISLAND","SECTOR","STRATA")
REGs=list(c("Main Hawaiian Islands"),c("Northwest Hawaiian Islands"))
ISLs=list(c("Hawaii","Kahoolawe","Kauai","Lanai","Maui","Molokai","Lehua","Niihau and Lehua","Oahu"),
          c("French Frigate Shoals","Kure Atoll","Lisianski","Pearl and Hermes Atolls"))

AOIbind=NULL
for (iS in 1:length(SPACE)){#iS=3
  #.1 Check FULL/LEFT
  Fdf=read.csv(file = paste0(inpath,infile_A,SPACE[iS],infile_F))
  Ldf=read.csv(file = paste0(inpath,infile_A,SPACE[iS],infile_L))
  CHECK=all.equal(Fdf,Ldf)
  print(paste0(SPACE[iS]," - F and L same? ",CHECK))
  
  if(CHECK){
    for (iR in 1:length(REGs)){#iR=1
      #2. Split REGION
      print(paste0("Splitting regions..",REGs[iR]))
      
      
      if(iS==1){REGdf=Fdf %>% filter(AOILabel==REGs[iR])
      }else{
        REGdf=Fdf %>% mutate(ISL_AOI=sub("\\;.*", "", Fdf$AOILabel)) %>% 
          filter(ISL_AOI%in%ISLs[[iR]]) %>% dplyr::select(-ISL_AOI)
      }
      #2B All N_ columns NA->0
      REGdf=REGdf %>% mutate(
        N_cover= replace_na(N_cover,replace = 0),
        N_demo= replace_na(N_demo,replace = 0),
        N_coverTREND= replace_na(N_coverTREND,replace = 0),
        N_demoTREND= replace_na(N_demoTREND,replace = 0)
      )
      #3. Output files
      finaloutfile=paste0(outpath,outfile_A,"_",SPACE[iS],"_",REGs[iR],outfile_B)
      print(paste0("Writing out: ",finaloutfile))
      write.csv(x = REGdf,file = finaloutfile,row.names = FALSE)
      
      #Bind AOI labels for lookup
      AOIdf=data.frame(AOI=unique(REGdf$AOILabel),Level=SPACE[iS])
      AOIbind=rbind(AOIbind,AOIdf)
    }  
  }else(print("FAIL"))
  write.csv(x = AOIbind,file=paste0(outpath,"AOI_unique.csv"))
}

##############################################################################################################################################################################################
##############################################################################################################################################################################################
#Compile Sampled Sites
inpath_sites=c("T:/Benthic/Data/Data Requests/NCRMPViztool/2024/unformatted/")
CoverSites=read.csv(paste0(inpath_sites,"2024ViztoolSites_Cover.csv"))
REAsites=read.csv("./surveysite.csv")
SiteTemplate=read.csv("T:/Benthic/Data/Data Requests/NCRMPViztool/2023/For Submission/March 2024 Submission/Files_Split_By_Tier_Region_MonitoringCycle/2023/NCRMP_Pacific_Benthic_SurveyedSites_DemoAndCover_2023_v1.1.csv")
...
head(SiteTemplate)
bindCover=CoverSites %>%
  dplyr::select(SITEVISITID,SITE,LATITUDE_LOV,LONGITUDE_LOV,OBS_YEAR,REGION,ISLAND,SEC_NAME,REEF_ZONE,DEPTH_BIN,STRATANAME_TRENDS) %>% 
  rename(LATITUDE=LATITUDE_LOV,LONGITUDE=LONGITUDE_LOV)
bindCover$Comment=""
bindREA=REAsites %>%
  dplyr::select(SITEVISITID,SITE,LATITUDE,LONGITUDE,OBS_YEAR,REGION,ISLAND,SEC_NAME,REEF_ZONE,DEPTH_BIN)
bindREA=bindREA %>% mutate(STRATANAME_TRENDS=paste(SEC_NAME,REEF_ZONE,DEPTH_BIN,sep="_"))
bindREA$Comment=""
outSites=rbind(bindCover,bindREA)
outSites=outSites %>% filter(OBS_YEAR==2024)
outSites=outSites %>% dplyr::select(-REEF_ZONE,-DEPTH_BIN)
names(outSites)=names(SiteTemplate)[-1]

#Look up for StrataName to AOI
#"T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/2024_ONLY/STRATA_NAME_to_AOI_Lookup,csv.csv"
AOIlucsv=read.csv(paste0(outpath,"STRATA_NAME_to_AOI_Lookup,csv.csv"))
AOIlu=AOIlucsv[,2];names(AOIlu)=AOIlucsv[,1]

#Do Lookup, drop STRATANAMES
outSites=outSites %>% mutate(StrataAOI=as.character(AOIlu[Strata])) %>% dplyr::select(-Strata) %>% 
  rename(Strata=StrataAOI) %>% distinct()
write.csv(x = outSites,file = paste0(outpath,"NCRMP_Pacific_Benthic_SurveyedSites_DemoAndCover_2024_v1.0_DRAFT.csv"),
          row.names = F)
...
write.csv(x = output_r_Ljoin_PN,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_REGION_LEFTJOIN_byGenus_PurgeNewJK_2025DEC12.csv")
...
write.csv(x = output_isl_Ljoin_PN,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_ISLAND_LEFTJOIN_byGenus_PurgeNewJK_2025DEC12.csv")
...
write.csv(x = output_SEC_Ljoin_PN,row.names = FALSE,
          file="T:/Benthic/Data/Data Requests/NCRMPViztool/2024/For Submission/2025DEC_Submission/PacificBenthicDataSummaryTable_SECTOR_LEFTJOIN_byGenus_PurgeNewJK_2025DEC12.csv")
