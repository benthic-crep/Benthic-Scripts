...
#write.csv(miss.from.smSITE,file="../fish-paste/data/SitesmissingfromSM_2024.csv") #export list and manually add to SM
...
write.csv(dpst, file="T:/Benthic/Data/REA Coral Demography & Cover/Summary Data/Stratum/BenthicCover_2010-2023_Tier1_STRATA_updated.csv",row.names = F)
#write.csv(dpst, file="T:/Benthic/Data/REA Coral Demography & Cover/Summary Data/Stratum/BenthicCover_2010-2023_Tier3_STRATA_updated.csv",row.names = F)
...
write.csv(dpsec, file="T:/Benthic/Data/REA Coral Demography & Cover/Summary Data/Sector/BenthicCover_2010-2023_Tier1_SECTOR_updated.csv",row.names = F)
#write.csv(dpsec, file="T:/Benthic/Data/REA Coral Demography & Cover/Summary Data/Sector/BenthicCover_2010-2023_Tier3_SECTOR_updated.csv",row.names = F)
...
write.csv(dpis, file="T:/Benthic/Data/REA Coral Demography & Cover/Summary Data/Island/BenthicCover_2010-2023_Tier1_ISLAND_updated.csv",row.names = F)
#write.csv(dpis, file="T:/Benthic/Data/REA Coral Demography & Cover/Summary Data/Island/BenthicCover_2010-2023_Tier3_ISLAND_updated.csv",row.names = F)
